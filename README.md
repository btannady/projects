...
<br />
<br />
As the principles behind the wireless Bluetooth stack were still unfamiliar to those in the Kin-Keepers startup, I was tasked with generating the first proof of concept for integrating the Bluetooth (GATT server/client interactions) into our company's internal software. As a result, my work involved both a great deal of programming, and a substantial amount of effort was dedicated towards self-learning to spearhead industry-level networking infrastructures for other engineering teams. 
<br />
<br />
