...
<br />
<br />
Considering the principles behind the wireless Bluetooth 4.0 stack were still unfamiliar to everyone in our company, I was tasked with pioneering and orchestrating the proof of concept for integrating GATT server/client interactions into our company's internal software. As a result, my work involved both a great deal of programming, and a substantial amount of my time was also spent self-learning to spearhead industry-level infrastructures into our company software. Along with this, I established detailed documentation explaining all of my significant findings, allowing for future engineering teams to have an easier time picking up similar embedded networking related projects. By the end of the summer, all project goals were favorably surpassed and accomplished. 
