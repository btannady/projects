...
Created using Riot Games' developer API to assist in tracking live gameplay statistics. Users are given the ability to quickly search in real-time for performance history statistics pertaining to their teammates and opponents. 
