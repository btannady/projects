...
<br />
<br />
Without giving away too much information, this was the project I undertook during my Summer 2020 internship that spanned several months in length. Although my work involved establishing a great deal of programming, a lot of my time was also spent pioneering/modernizing industry-level infrastructures into our company software. During my time at Kin-Keepers, I created surveillance software for the Biometrics IoT Integration team. The project's goal is to successfully allow our company software to probe manufactured devices in real-time for elderly heart rate and accelerometer movement detection data wirelessly over Bluetooth LE signals.
<br />
