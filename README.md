...
<br />
<br />
This was the project I undertook during my Summer 2020 internship. During this time, I worked as a Software Engineer Intern for a senior health-tech startup named Kin-Keepers. This company specializes in creating different services and tools aimed in supporting the elderly community. Within these four months, I pioneered and created embedded networking software with Bash and Python for the Biometrics IoT Integration team. The project's goal was to successfully grant our company AI a secure, stable, and wireless pipeline, capable of obtaining elderly heart rate and movement detection data wirelessly over Bluetooth LE signals. The types of hardware involved were primarily lightweight and wearable devices, capable of transmitting biometric data in real-time (e.g. smartwatch).
<br />
<br />
