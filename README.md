...
<br />
<br />
This was the project I undertook during my Summer 2020 internship that spanned several months in length. During this time, I worked as a Software Engineer Intern for a company called Kin-Keepers. This company specializes in creating different services and technological tools aimed in supporting the elderly community. Within those several months, I created embedded software for the Biometrics IoT Integration team. The project's goal was to successfully grant our company AI a secure, stable, and wireless pipeline, capable of obtaining elderly heart rate and accelerometer data wirelessly over Bluetooth LE signals. Hardware this project primarily focused targetted light-weight and wearable devices capable of transmitting biometric data in real-time.
<br />
<br />
Considering the principles behind wireless Bluetooth 4.0 stack were still unfamiliar everyone in the company, I was tasked with pioneering and and orchestrating the proof of concept for integrating GATT server/client interactions into our company's internal software. As a result, my work involved both a great deal of programming, and a lot of my time was also spent self-learning to spearheading industry-level infrastructures into our company software. By the end of the summer, all project goals were favorably surpassed and accomplished. 
Through this learning experience, I cultivated an API pipeline capable of obtaining, handling, and streamlining data directly to the Kin-Keepers's 'PET' voice assistant AI to alert of potential incidents (involving our elderly clients) to prevent escalation of disasterous events.
