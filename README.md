...
<br />
<br />
This was the project I undertook during my Summer 2020 internship. During this time, I worked as a Software Engineer Intern for a senior health-tech startup named Kin-Keepers. This company specializes in creating different services and tools aimed in supporting the elderly community. 
<br />
Within these four months, I pioneered and created embedded networking software with Bash and Python for the Biometrics IoT Integration team. The project's goal was to successfully grant our company AI a secure, stable, and wireless pipeline, capable of obtaining elderly heart rate and movement detection data wirelessly over Bluetooth LE signals. The types of hardware involved were primarily lightweight and wearable devices, capable of transmitting biometric data in real-time (e.g. smartwatches).
<br />
<br />
...
<br />
<br />
By the end of the summer, all project goals were favorably surpassed and accomplished. Our API pipeline grew capable of obtaining, handling, and streamlining data directly to the Kin-Keepers's 'PET' voice assistant AI to alert of potential life-concerning incidents (involving our elderly clients) and prevent escalation of such events.
<br />
Project development was primarily fostered under the Agile SCRUM methodologies, where I'd routinely be communicating with cross-functional teams for daily standup meetings, sprint reviews, refinement sessions, and so on.
<br />
<br />
