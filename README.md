...
<br />
<br />
Without giving away too much information, this was the project I undertook during my Summer 2020 internship that spanned several months in length. Although my work involved establishing a great deal of programming, a lot of my time was also spent pioneering and modernizing industry-level infrastructures into our company software. During my time at Kin-Keepers, I created surveillance software for the Biometrics IoT Integration team. The project's goal was to successfully grant our company software a secure, stable, and wireless pipeline, capable of probing wearable devices (in real-time) for elderly heart rate and accelerometer movement detection data over Bluetooth LE signals.
<br />
Considering the principles behind BLE intregration were still unfamiliar to our team, I was tasked with spearheading and orchestrating the proof of concept for integrating GATT server/client interactions into our company's internal software.
